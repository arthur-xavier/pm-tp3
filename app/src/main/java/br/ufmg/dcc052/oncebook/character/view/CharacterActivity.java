...
import br.ufmg.dcc052.oncebook.character.presentation.CharacterPresenter;
import br.ufmg.dcc052.oncebook.relationship.view.RelationshipActivity;
...
public class CharacterActivity
  ...
  public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
    br.ufmg.dcc052.oncebook.character.domain.Character character = (Character)parent.getItemAtPosition(position);
