package br.ufmg.dcc052.oncebook.character.presentation;
...
import br.ufmg.dcc052.oncebook.character.view.CharacterView;
...
public class CharacterPresenter implements Refreshable {
  ...
  private br.ufmg.dcc052.oncebook.character.domain.Character selectedCharacter;
  private Book book;
